module.exports = (obj, css, about, bottomLinks) => {
  ...
  <head>
       ...
       <style type='text/css'>
          * { margin: 0; padding: 0; }
          ...
          #pic { float: right;width: 150px;height:150px;border-radius: 50%;border:2px solid ${css.fontColor}; }
          ...
          #bottom-links {position: relative;margin-top: 15%;width: 50%;margin-left: auto;margin-right: auto;display: flex;justify-content: center;}
          .ss{padding-right: 15px;color:${css.fontColor};}
          ...
          #credit {width: 800px;text-align: center;font-size: 10px;margin: 0 auto;}
       </style>
  </head>
  ...
  <body>
      ...
      <div id='page-wrap'>
          ...
          <img src='${obj.profilePhoto}' alt='Photo of ${obj.name}' id='pic' />
